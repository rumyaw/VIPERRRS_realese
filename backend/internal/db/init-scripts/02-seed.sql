...
-- 18. Хакатон GreenHack — ГринСтарт, Москва
INSERT INTO opportunities (
  id, author_id, title, short_description, full_description, company_name,
  type, work_format, location_label, lon, lat,
  published_at, valid_until, salary_min, salary_max, currency,
  ...
  '00000000-0000-4000-8000-000000000003',
  'Хакатон GreenHack 2026',
  'Хакатон по разработке экотехнологий. 48 часов, призовой фонд, менторы из индустрии.',
  'Приглашаем студентов и молодых специалистов на хакатон GreenHack 2026! Темы: умный город, углеродный след, зелёная логистика. Призовой фонд 500 000₽, стажировки победителям. Регистрация бесплатная.',
  'ГринСтарт',
  'event',
  'office',
  'Москва, Цифровой деловой центр',
  37.5350, 55.7498,
  '2026-03-25', '2026-05-15',
  0, 0, 'RUB',
  '{"email":"events@greenstart.ru","telegram":"@greenstart_events"}'::jsonb,
  ARRAY['Hackathon','GreenTech','Innovation','Teamwork']::text[],
  'intern', 'project',
  'approved'
) ON CONFLICT (id) DO NOTHING;

-- 19. День открытых дверей ТехКорп — Москва
INSERT INTO opportunities (
  id, author_id, title, short_description, full_description, company_name,
  type, work_format, location_label, lon, lat,
  published_at, valid_until, salary_min, salary_max, currency,
  ...
  '00000000-0000-4000-8000-000000000002',
  'День открытых дверей ТехКорп',
  'Знакомство с компанией, экскурсия по офису, Q&A с разработчиками.',
  'Приходите познакомиться с командой ТехКорп! Экскурсия по офису, демонстрация проектов, ответы на вопросы о карьере. Для студентов и выпускников IT-направлений.',
  'ТехКорп',
  'event',
  'office',
  'Москва, Пресненская наб.',
  ...
  0, 0, 'RUB',
  '{"email":"hr@techcorp.ru","telegram":"@techcorp_events"}'::jsonb,
  ARRAY['OpenDay','Networking','Career','IT']::text[],
  'intern', 'project',
  'approved'
) ON CONFLICT (id) DO NOTHING;

-- 20. Лекция: Карьера в IT — ГринСтарт, СПб
INSERT INTO opportunities (
  id, author_id, title, short_description, full_description, company_name,
  type, work_format, location_label, lon, lat,
  published_at, valid_until, salary_min, salary_max, currency,
  ...
  '00000000-0000-4000-8000-000000000003',
  'Лекция: Карьера в GreenTech',
  'Открытая лекция о карьерных возможностях в сфере зелёных технологий.',
  'Спикеры из ГринСтарт расскажут о трендах GreenTech, ESG-регулировании и карьерных перспективах. После лекции — нетворкинг и возможность задать вопросы.',
  'ГринСтарт',
  'event',
  'office',
  'Санкт-Петербург, Невский пр.',
  ...
  0, 0, 'RUB',
  '{"email":"hr@greenstart.ru"}'::jsonb,
  ARRAY['Lecture','GreenTech','Career','Networking']::text[],
  'intern', 'project',
  'approved'
) ON CONFLICT (id) DO NOTHING;

-- 21. Менторская программа по UX — ГринСтарт
INSERT INTO opportunities (
  id, author_id, title, short_description, full_description, company_name,
  type, work_format, location_label, lon, lat,
  published_at, valid_until, salary_min, salary_max, currency,
  ...
  '00000000-0000-4000-8000-000000000003',
  'Менторская программа по UX-дизайну',
  'Индивидуальное наставничество от UX-лида ГринСтарт для начинающих дизайнеров.',
  'Программа длится 3 месяца: еженедельные 1-on-1 встречи, разбор портфолио, работа над реальным проектом, подготовка к собеседованиям в топовые компании.',
  'ГринСтарт',
  'mentorship',
  'remote',
  'Удалённо (Россия)',
  ...
  0, 0, 'RUB',
  '{"email":"hr@greenstart.ru","telegram":"@greenstart_mentors"}'::jsonb,
  ARRAY['UX','Mentorship','Design','Figma','Career']::text[],
  'intern', 'part',
  'approved'
) ON CONFLICT (id) DO NOTHING;

-- 22. Менторская программа по Data Science — ТехКорп
INSERT INTO opportunities (
  id, author_id, title, short_description, full_description, company_name,
  type, work_format, location_label, lon, lat,
  published_at, valid_until, salary_min, salary_max, currency,
  ...
  '00000000-0000-4000-8000-000000000002',
  'Наставник по Data Science',
  'Менторская программа для начинающих дата-сайентистов от экспертов ТехКорп.',
  'Программа наставничества ТехКорп: индивидуальные встречи с ментором, разбор kaggle-задач, помощь с ML-проектами, подготовка к собеседованиям. Длительность 4 месяца.',
  'ТехКорп',
  'mentorship',
  'hybrid',
  'Москва, Пресненская наб.',
  ...
  0, 0, 'RUB',
  '{"email":"hr@techcorp.ru","telegram":"@techcorp_mentors"}'::jsonb,
  ARRAY['Data Science','Python','ML','Mentorship','Career']::text[],
  'intern', 'part',
  'approved'
) ON CONFLICT (id) DO NOTHING;
...
-- ============================================================
-- Curator role (from migration 0003)
-- ============================================================
